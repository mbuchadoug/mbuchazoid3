...
function allocateRoom()
{
    ...
    var floor = document.sample.floor.value;
  ...
  var photo =  document.sample.photo.value;
    var class1=document.sample.class1.value;
    
    var room=document.sample.room.value;

console.log(photo,'flight')
    
	$.ajax({
   
    dataType: 'json',
    type: 'POST',
	data:{grade:grade,photo:photo,floor:floor,studentName:studentName,occupants:occupants,studentId:studentId,gender:gender,class1:class1 },
    url: "/hostel/studentRoom",
    success: function(data) {
...
link.className = "text-end";
    ...
    let link2 = "/hostel/alloSubRoomDelete/"+data._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
    // link.appendChild(linkText);
    link.href="/hostel/alloSubRoomDelete/"+data._id
    //td5.innerText = 'Delete'
    link.innerHTML='<a href="'+link2+'">'+linkText+'</a>'
