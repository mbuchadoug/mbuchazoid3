...
link.setAttribute("href", "/hostel/alloBatchDelete/"+data[i]._id)
...
td6.innerHTML = data[i].hostelName;

   
   
    let link2 = "/hostel/alloBatchDelete/"+data[i]._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
   // link.appendChild(linkText);
link.href="/hostel/alloBatchDelete/"+data[i]._id
...
function allocateRoom()
{
  ...
  var gender =  document.sample.gender.value;
    ...
    dataType: 'json',
    type: 'POST',
	data:{grade:grade,studentName:studentName,occupants:occupants,studentId:studentId,gender:gender,class1:class1,room:room },
    url: "/hostel/studentRooms",
    success: function(data) {
...
td6.classList.add('text-end', 'pe-0')
link.classList.add('text-end','pe-0')
link.setAttribute("href", "/hostel/subBatchDelete")
link.className = "text-end";
    ...
    td4.innerHTML = data.room;
    td6.innerHTML = data.hostel;
  

    let link2 = "/hostel/alloBatchDelete/"+data._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
    // link.appendChild(linkText);
    link.href="/hostel/alloBatchDelete/"+data._id
    //td5.innerText = 'Delete'
    link.innerHTML='<a href="'+link2+'">'+linkText+'</a>'
