            ...
            return o = e.extend({
                ...
                function v(e, t) {
                    ...
                    if (!(e < 0)) {
                        for (n = e, a = p(t); n < h; n++)
                            if (l[n]) {
                                if (!(a < h && l[n].test(S[a]))) break;
                                S[n] = S[a], S[a] = g(a), a = p(a)
                            }
                        x(), R.caret(Math.max(f, e))
                    }
                }
                ...
                function k(e) {
                    ...
                    if (m && m.length && m.length > t.length) {
                        for (; n.begin > 0 && !l[n.begin - 1];) n.begin--;
                        if (0 === n.begin)
                ...
                function j(e) {
                    ...
                    for (t = 0, a = 0; t < h; t++)
                        ...
                        } else S[t] === i.charAt(a) && a++, t < u && (r = t);
                    return e ? x() : r + 1 < u ? o.autoclear || S.join("") === A ? (R.val() && R.val(""), y(0, h)) : x() : (x(), R.val(R.val().substring(0, r + 1))), u ? t : f
                }
                var R = e(this),
                    S = e.map(n.split(""), function(e, t) {
                        if ("?" != e) return c[e] ? g(t) : e
                    }),
                    A = S.join(""),
                    T = R.val();
                R.data(e.mask.dataName, function() {
                    ...
                    if (!R.prop("readonly")) {
                        clearTimeout(t);
                        var e;
                        T = R.val(), e = j(), t = setTimeout(function() {
                            R.get(0) === document.activeElement && (x(), e == n.replace("?", "").length ? R.caret(0, e) : R.caret(e))
                        }, 10)
                    }
                }).on("blur.mask", b).on("keydown.mask", function(e) {
                    if (!R.prop("readonly")) {
                        var t, n, i, r = e.which || e.keyCode;
                        m = R.val(), 8 === r || 46 === r || a && 127 === r ? (n = (t = R.caret()).begin, (i = t.end) - n == 0 && (n = 46 !== r ? function(e) {
                            for (; --e >= 0 && !l[e];);
                            return e
                        }(n) : i = p(n - 1), i = 46 === r ? p(i) : i), y(n, i), v(n, i - 1), e.preventDefault()) : 13 === r ? b.call(this, e) : 27 === r && (R.val(T), R.caret(0, j()), e.preventDefault())
                    }
                    ...
                    if (!R.prop("readonly")) {
                        ...
                        if (!(t.ctrlKey || t.altKey || t.metaKey || o < 32) && o && 13 !== o) {
                            if (c.end - c.begin != 0 && (y(c.begin, c.end), v(c.begin, c.end - 1)), (n = p(c.begin - 1)) < h && (a = String.fromCharCode(o), l[n].test(a))) {
                                if (function(e) {
                                        var t, n, a, i;
                                        for (t = e, n = g(e); t < h; t++)
                                            if (l[t]) {
                                                if (a = p(t), i = S[t], S[t] = n, !(a < h && l[a].test(i))) break;
                                                n = i
                                            }
                                    }(n), S[n] = a, x(), i = p(n), r) {
                                    var u = function() {
                ...
                }), i && r && R.off("input.mask").on("input.mask", k), j()
            })
        }
    })
});