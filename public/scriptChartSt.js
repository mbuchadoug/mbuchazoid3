...
link.setAttribute("href", "/teacher/delete")
...
link.href="/teacher/delete/"+data[i]._id
...
$.ajax({
  dataType: 'json',
            ...
            type: 'POST',
            url: "/teacher/topic/update/"+td.id,
...
link.className = "text-end";
    ...
    var linkText = 'Delete'
    // link.appendChild(linkText);
    link.href="/teacher/delete/"+data._id
    //td5.innerText = 'Delete'
    link.innerHTML='<a href="'+link2+'">'+linkText+'</a>'
