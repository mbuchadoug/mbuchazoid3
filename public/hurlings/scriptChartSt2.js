...
td5.appendChild(link);*/
    ...
    let link2 = "/hurlings/classBatchDelete/"+data[i]._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
   // link.appendChild(linkText);
link.href="/hurlings/classBatchDelete/"+data[i]._id
...
$.ajax({
  dataType: 'json',
            ...
            type: 'POST',
            url: "/hurlings/classesV/update/"+td1.id,
...
link.className = "text-end";
    ...
    let link2 = "/hurlings/classBatchDelete/"+data._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
    // link.appendChild(linkText);
    link.href="/hurlings/classBatchDelete/"+data._id
    //td5.innerText = 'Delete'
    link.innerHTML='<a href="'+link2+'">'+linkText+'</a>'
